...
* The original package name 'com.github.fabriciolfj.product-service' is invalid and this project uses 'com.github.fabriciolfj.product_service' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/3.3.10/reference/data/nosql.html#data.nosql.redis)
